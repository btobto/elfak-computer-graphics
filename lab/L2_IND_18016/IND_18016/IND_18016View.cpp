...
void CIND18016View::RotateAroundPoint(CDC* pDC, float tX, float tY, int angle, bool rightMultiply)
{
...
inline void CIND18016View::DrawCircle(CDC* pDC, POINT center, int radius)
{
...
void CIND18016View::DrawPot(CDC* pDC)
{
...
void CIND18016View::DrawTextWithShadow(CDC* pDC, CString text, POINT location, LOGFONT logFont, COLORREF color, COLORREF shadowColor, int offset)
{
	CFont font;
...
void CIND18016View::DrawCactus(CDC* pDC, float x, float y, float widthFactor, float heightFactor, int rotAngle, const HENHMETAFILE& mf)
{
	XFORM oldXForm;
...
void CIND18016View::DrawFigure(CDC* pDC)
{
