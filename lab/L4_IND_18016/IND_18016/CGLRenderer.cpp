...
void CGLRenderer::PrepareScene(CDC* pDC)
{
    ...
    glClearColor(0.00, 0.80, 0.00, 0.0);
...
{
    m_zoomDistance += val;
    if (m_zoomDistance < 5) m_zoomDistance = 5;
...
void CGLRenderer::DrawFigure(double angle)
{
    ...
    glPushMatrix();
    {
        ...
        // first cyl
        glTranslated(0, vaseTopH - sphereR, 0);
        glRotated(m_armRotAngle, 1, 0, 0);
