...
void CGLRenderer::PrepareScene(CDC* pDC)
{
    ...
    float lmAmbient[] = { 0.8, 0.8, 0.8, 1.0 };
...
void CGLRenderer::DrawTruck()
{
    ...
    glPushMatrix();
    {
        ...
        DrawWheel(2.5, 0.5, -0.5);
        DrawWheel(2.5, 3.5, -0.5);

        DrawWheel(7.5, 0.5, -0.5);
        DrawWheel(7.5, 3.5, -0.5);
...
void CGLRenderer::DrawTruckCover()
{
    glBegin(GL_QUADS);
    {
        ...
        glNormal3f(-cos(M_PI / 4), sin(M_PI / 4), 0);
        glVertex3f(2, 7, 0);
        glVertex3f(0, 5, 0);
        glVertex3f(0, 5, 5);
        glVertex3f(2, 7, 5);
